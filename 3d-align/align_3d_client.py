...
class Align3DClient:
    """
    Client for the 3D Align prediction API.

    Example usage:
        client = Align3DClient(
        ...
        ligands = [
            LigandInput(id="ligand_0", smiles="CCO"),
            LigandInput(id="ligand_1", smiles="CCN"),
        ]
    ...
    def create_request(
        ...
        """
        Submit an alignment request: one reference ligand + a list of query
        ligands (SMILES). No protein required.
        """
